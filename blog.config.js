...
const BLOG = {
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '茶ICP备2025110225号', // 备案号 闽ICP备XXXXXX
  BEI_AN_LINK: process.env.NEXT_PUBLIC_BEI_AN_LINK || 'https://icp.redcha.cn/beian/ICP-2025110225.html', // 备案查询链接，如果用了萌备等备案请在这里填写
